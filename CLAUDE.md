...
**Tier 1 — out-of-sample predictions** (uncalibrated, bottom-up from SOI filer counts, module revenue identities and source-stated spending levels; the genuine test). **25 pre-registered cases, mean abs error 52.6% (median 21.1%), 8/25 within 15%, 14/25 within 25%.** Never state this as a single "validated within X%" number — the distribution has a tight core and a long tail, and each tail case has a documented structural cause: rate changes at conventional thresholds land at 2–21%, fast-spending discretionary funding cuts at 6–23%, and everything behavioural (capital gains, gains at death, payroll incidence, corporate margins) at 47–154%.
