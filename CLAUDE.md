...
All core features, all four horizon features, the distributional-validation cycle, and the Ask assistant feature are complete (May 2026). **3518 tests passing across the model + Ask stack** (7 skipped; `python -m pytest tests/ -q`).
