...
pytest tests/ -v          # Run the test suite (1094 tests)
...
3. **Write tests** for new functionality — the project maintains 1094 tests at 83%+ coverage with an 80% enforced floor
