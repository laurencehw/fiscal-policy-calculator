...
pytest tests/ -v          # Run the test suite (1107 tests)
...
3. **Write tests** for new functionality — the project maintains 1107 tests at 84%+ coverage with an 83% enforced floor
