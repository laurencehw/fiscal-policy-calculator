...
| E — provenance cleanup, missing runners ✅ | 2 lanes | **22** (one retired, one re-sourced) | count that survives a referee (calibrated 29 → 46; 12 honestly reported as unfitted; 24 targets transcribed, 15 of them disagreeing with their source; headline 68 rows → **61 published benchmarks**) |
