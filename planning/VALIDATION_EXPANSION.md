...
- **The spend-out gap is the highest-value missing feature, and now has a magnitude.** Seven spending cases, errors 6% to 356%, all one cause. IIJA quantifies the ceiling: $163.0B of front-loaded budget authority produces a $415.4B outlay total that a level shape scores at $1,894B. Spreading the stated five-year authorization evenly still gives ~$950B, so this is not a level-choice artifact.
...
*Items 1 and 3 landed 2026-09-01 (`validation/phase-e-runners`). Item 2 is labelled but the illustrations are still carried in the scorecard, out of the headline count — see below.*
