...
> **26 out-of-sample cases, mean abs error 14.5%, 16/26 within 15%, 22/26 within 25%** (median 11.5%). The tier is **eight policy classes** and must never be quoted as one number: AGI-inclusive surtax 17.6% (n=6), capital gains 18.7% (4), ordinary rate change 14.8% (4), corporate 44.5% (1), enacted-law spending 13.4% (3), discretionary spending 4.6% (5), payroll 7.8% (2), tax-expenditure cap 13.1% (1) — each now carrying its own CI ceiling.
...
| Treasury 39.6% + step-up repeal | -$322B | -$316B | 2% | Treasury (2021-05) | Green Book FY2022, scored on its own FY2022-2031 decade | `d11bf2c`, scored `6c9bfa2`; `.v2` window `2d13e60` |
| All ordinary rates +1pp | -$1,185B | -$1,207B | 2% | CBO Options 2025-2034 #45 (2024-12) | CBO Feb 2024 (matched) | `752f0f1`, scored `36d683f` |
...
| AGI surtax 2pp (>$100K single) | -$1,051B | -$1,081B | 3% | CBO Options 2025-2034 #46 (2024-12) | CBO Feb 2024 (matched) | `752f0f1`, scored `36d683f` |
| AGI surtax 1pp (>$20K single) | -$1,440B | -$1,333B | 7% | CBO Options 2025-2034 #46 (2024-12) | CBO Feb 2024 (matched) | `752f0f1`, scored `36d683f` |
...
| Top four ordinary brackets +2pp | -$570B | -$654B | 15% | CBO Options 2025-2034 #45 (2024-12) | CBO Feb 2024 (matched) | `752f0f1`, scored `36d683f` |
| Biden top rate 39.6% ($400K+) | -$246B | -$290B | 18% | Treasury (2024-03), Green Book FY2025 table row | Green Book FY2025 | `318be6b` (`.v2`, superseding `.v1`), scored `22ccdd2` |
...
| 2pp rate cut ($500K+) | +$400B | +$473B | 18% | Tax Policy Center (2023-06) — no source URL | CBO Feb 2023 | `be7e947` |
| 5pp top rate ($1M+) | -$700B | -$842B | 20% | Tax Policy Center (2023-06) — no source URL | CBO Feb 2023 | `be7e947` |
| 1pp all brackets | -$960B | -$1,195B | 24% | JCT (2023-01) — no source URL; scores the same reform as CBO Option 45 above, 23.5% apart | CBO Feb 2023 | `be7e947` |
| Warren surtax 3pp (AGI >$2M) | -$350B | -$437B | 25% | Tax Policy Center (2020) — no source URL | unstated (secondhand) | `6c9bfa2` |
...
| Medicare surcharge 2pp (>$400K) | -$310B | -$409B | 32% | Treasury (2024) | Green Book FY2025 | `6c9bfa2` |
| Tax accrued gains at death | -$536B | -$346B | 35% | CBO Options 2025-2034 #51 (2024-12) | CBO Feb 2024 (matched) | `752f0f1`, scored `36d683f` |
...
|--------|---:|---:|
| Benchmarks | **16** | **39** |
| Mean absolute error | **1.5%** | **56.7%** |
| Median absolute error | 0.1% | 36.9% |
| Within 15% of official | 16/16 | 10/39 |
| Within 25% of official | 16/16 | 13/39 |
...
| Trade | Universal 10% tariff | **-$2,171.1B** | -$1,370B | **36.9%** | Poor | line_item (**target revised** from -$2,000B); unfitted since L8; retaliation left the score in PR #150 |
| Trade | 60% China tariff | **-$650B** | -$331B | **49.1%** | Poor | line_item (**target revised** to CRFB's -$650B in PR #145); unfitted since L8 |
| Trade | 25% auto tariff | **-$386.2B** | -$204B | **47.2%** | Poor | line_item (**target revised** from -$100B, a per-year claim in a ten-year column) |
...
| Trade | 5 | **0** | **43.6%** | 25% steel/aluminium **75.3%** — a *registered regression* against an untraceable target; on the four rows that have a document the family reads **35.7%** |
