...
> **26 out-of-sample cases, mean abs error 14.7%, 15/26 within 15%, 23/26 within 25%** (median 12.6%). The tier is **eight policy classes** and must never be quoted as one number: AGI-inclusive surtax 17.6% (n=6), capital gains 20.5% (4), ordinary rate change 14.8% (4), corporate 44.5% (1), enacted-law spending 13.4% (3), discretionary spending 4.6% (5), payroll 7.8% (2), tax-expenditure cap 13.1% (1) — each now carrying its own CI ceiling.
