...
def validate_tcja_extension(
    ...
    if verbose:
        ...
        print(f"Rating: {validation_result.accuracy_rating}")
        print("\nYear-by-year costs:")
        for _i, (year, cost) in enumerate(zip(result.years, result.final_deficit_effect, strict=False)):
        ...
        if breakdown:
            ...
            for _key, comp in breakdown.items():
...
def validate_corporate_policy(
    ...
    if verbose:
        ...
        print(f"Rating: {validation_result.accuracy_rating}")
        print("\nYear-by-year:")
        for _i, (year, rev) in enumerate(zip(result.years, result.final_deficit_effect, strict=False)):
