...
_KNOWN_LIMITATIONS_BY_POLICY_ID: dict[str, list[str]] = {
    ...
    "iija_2021_discretionary": [
        ...
        "0.3%.",
        "What is left is a 4.3% over-statement of the TOTAL netting against the "
        "tail the window still clips, and neither term is behavioural. Outlays "
        "across every year the policy touches are $433.2B, which is just the "
        "profile's 0.973 spend-out sum applied to the full authority; $18.9B of "
        "them fall in FY2032 or later, outside even this window. The two nearly "
        "cancel, so 0.3% is smaller than either term and should not be read as "
        "evidence about the spend-out profile. The honest statement is that the "
        "authority path is CBO's own and the profile reproduces its total to "
        "4.3%.",
