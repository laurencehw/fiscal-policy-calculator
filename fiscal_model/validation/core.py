...
_KNOWN_LIMITATIONS_BY_POLICY_ID: dict[str, list[str]] = {
    ...
    "treasury_capgains_39_plus_stepup_elim": [
        ...
        "the rate channel is $303.1B and the death channel $78.0B under this "
        ...
        "The window was worth 27.0 points, not the 'about 17' an earlier version "
        "of this note claimed. Re-scoring the same shape on the default "
        "FY2025-2034 decade returns -$468.3B and 45.4%, against -$381.1B and "
        "18.4% on FY2022-2031; scripts/window_offset_capgains.py prints both. "
        ...
        "PR #126 measured the offset at 28.7 of 43.3 points; PR #132's decedent "
        "ladder landed in the same wave and moved both columns, so 27.0 of 45.4 "
        "is the merged figure and neither branch's number is it. The control is "
        ...
        "18.4% is not accuracy either, and what the window removed was an "
        "accounting artefact rather than a disagreement. On its own decade the "
        "row is a net: the model books $9.1B of revenue across FY2022-2024 "
        "where Treasury books $66.0B - the model's enactment year is a $59.0B "
        "transitory revenue LOSS against Treasury's $7.7B gain, because the "
        "module has no receipts lag - against $372.0B across FY2025-2031 where "
        "Treasury books $256.5B. Treasury's own answer for this row is not "
        ...
        "exclusion alone - $1M against $5M - and on the common FY2025-2034 "
        "decade the model pays $85.0B of death channel for that step where the "
        "two published rows differ by $33.4B. Wave 4 blamed the five-class "
        "ladder for it; Wave 7 replaced the ladder with a fitted size "
        "distribution and the step went 82.3 to 85.0, i.e. the wrong way, so "
        "dispersion was not the cause "
