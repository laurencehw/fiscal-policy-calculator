...
def _display_dynamic_metrics(st_module: Any, macro_result: Any) -> None:
    """Display four metric cards for key macroeconomic effects."""
...
def _display_budget_comparison(st_module: Any, result_data: Any, macro_result: Any) -> None:
    """Display conventional vs dynamic budget comparison."""
    st_module.markdown("---")
...
def _display_macroeconomic_charts(st_module: Any, macro_result: Any) -> None:
    """Display three Plotly charts for year-by-year macroeconomic effects."""
    st_module.markdown("---")
...
def _display_interest_and_methodology(
    st_module: Any, macro_result: Any, adapter: Any, frbus_adapter_lite_cls: Any
) -> None:
    """Display interest rate effects, detailed results table, and methodology notes."""
    st_module.markdown("---")
...
def render_dynamic_scoring_tab(
    ...
    try:
        ...
        _display_dynamic_metrics(st_module, macro_result)
        _display_budget_comparison(st_module, result_data, macro_result)
        _display_macroeconomic_charts(st_module, macro_result)
        _display_interest_and_methodology(st_module, macro_result, adapter, frbus_adapter_lite_cls)
        ...
        st_module.error(f"Unexpected error in dynamic scoring: {e}")
        import traceback
