...
""")
    ...
    with st_module.expander("Capital gains methodology"):
        st_module.markdown(
            ...
            "multiplier drops to 1.0x. The PWBM no-step-up validation case "
            "uses a 1.5x residual avoidance multiplier to capture remaining "
            "threshold timing and business-form shifting.\n\n"
            "**Sources:**\n"
