"""
Simple OLG Model for Classroom / Generational Burden Analysis
...
class OLGParams:
    """
    Calibration parameters for the simple OLG model.
...
class OLGResult:
    """
    Results from a simple OLG simulation.
...
class SimpleOLGModel:
    """
    Simple OLG model for generational burden analysis (classroom use).
